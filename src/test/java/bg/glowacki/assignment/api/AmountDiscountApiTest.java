...
@TestPropertySource(locations = "classpath:amount.properties")
class AmountDiscountApiTest {
    ...
    public static Stream<Arguments> happyPathArguments() {
        return Stream.of(
                ...
                Arguments.of(DiscountRequest.builder()
                                ...
                                .build(),
                        new DiscountResponse(new BigDecimal("98.00"))),
                Arguments.of(DiscountRequest.builder()
                                .productId(UUID.randomUUID())
                                .amount(100)
                                .unitPrice(BigDecimal.TEN)
                                .build(),
                        new DiscountResponse(new BigDecimal("995.00"))),
                Arguments.of(DiscountRequest.builder()
                                .productId(UUID.randomUUID())
                                .amount(100)
                                .unitPrice(new BigDecimal("0.01"))
                                .build(),
                        new DiscountResponse(BigDecimal.ZERO))
        );
    }
}
